...
namespace Optional
{
    public static class OptionExtensions
    {
        ...
        public static Option<T, TException> SomeWhen<T, TException>(this T value, Func<T, bool> predicate, TException exception) =>
            predicate(value) ? Option.Some<T, TException>(value) : Option.None<T, TException>(exception);
        ...
        public static Option<T, TException> SomeWhen<T, TException>(this T value, Func<T, bool> predicate, Func<TException> exceptionFactory) =>
            predicate(value) ? Option.Some<T, TException>(value) : Option.None<T, TException>(exceptionFactory());
        ...
        public static Option<T> NoneWhen<T>(this T value, Predicate<T> predicate) =>
            value.SomeWhen(val => !predicate(val));
        ...
        public static Option<T, TException> NoneWhen<T, TException>(this T value, Predicate<T> predicate, TException exception) =>
            value.SomeWhen(val => !predicate(val), exception);
        ...
        public static Option<T, TException> NoneWhen<T, TException>(this T value, Predicate<T> predicate, Func<TException> exceptionFactory) =>
            value.SomeWhen(val => !predicate(val), exceptionFactory);
        ...
        public static Option<T, TException> SomeNotNull<T, TException>(this T value, Func<TException> exceptionFactory) =>
            value.SomeWhen(val => val != null, exceptionFactory);
        ...
        public static Option<T, TException> ToOption<T, TException>(this Nullable<T> value, Func<TException> exceptionFactory) where T : struct =>
            value.HasValue ? Option.Some<T, TException>(value.Value) : Option.None<T, TException>(exceptionFactory());
